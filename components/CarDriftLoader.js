            ...
            <React.Fragment>
               <svg className="mainSVG" viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        ...
                        s-1.5-1.6-3.4-1C2.5,0.5,2.1,2.3,2.1,2.3S0,2.3,0,4.4c0,1.1,1,2.1,2.2,2.1C2.2,7.9,3.5,8.2,4.5,8.3z" fill="#dfdfdf" />
                        <circle id="dot" cx="0" cy="0" r="5" fill="#dfdfdf" />
                    </defs>

                    <circle id="mainCircle" fill="none" stroke="none" strokeWidth="2" strokeMiterlimit="10" cx="400" cy="300" r="130" />
                    <circle id="circlePath" fill="none" stroke="none" strokeWidth="2" strokeMiterlimit="10" cx="400" cy="300" r="80" />

                    <g id="mainContainer">
                        <g id="car">
                        <path id="carRot" fill="#121212" d="M45.6,16.9l0-11.4c0-3-1.5-5.5-4.5-5.5L3.5,0C0.5,0,0,1.5,0,4.5l0,13.4c0,3,0.5,4.5,3.5,4.5l37.6,0
